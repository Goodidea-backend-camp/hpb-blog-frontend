  ...
  describe('buildNewArticlePayload', () => {
    ...
    describe('HTML to Markdown conversion', () => {
      it('should convert HTML content to Markdown format', () => {
        const result = buildNewArticlePayload(baseFormValues, true)
      ...
      it('should handle complex HTML structures', () => {
        ...
        const result = buildNewArticlePayload(complexFormValues, true)
    ...
    describe('immediate publish mode', () => {
      it('should set published_at to current time when publishing immediately', () => {
        const result = buildNewArticlePayload(baseFormValues, false)
    ...
    describe('scheduled publish mode', () => {
      it('should set published_at to scheduled time when publishing with schedule', () => {
        ...
        const result = buildNewArticlePayload(scheduledFormValues, false)
      ...
      it('should ignore scheduled time when saving as draft', () => {
        ...
        const result = buildNewArticlePayload(scheduledFormValues, true)
    ...
    describe('edge cases', () => {
      it('should handle empty HTML content', () => {
        ...
        const result = buildNewArticlePayload(emptyContentValues, true)
      ...
      it('should handle plain text content (no HTML tags)', () => {
        ...
        const result = buildNewArticlePayload(plainTextValues, true)
